...
- **数据获取**：默认使用网页抓取方式，更稳定可靠；也可选择API方式（需配置Cookie）
...
2. **配置B站API认证（用于获取UP视频和标签）**
   - 从浏览器开发者工具中获取Cookie（详见 [API认证配置说明](./extension/api/README.md)）
   - 在设置页面中点击"如何获取Cookie？"链接查看详细步骤
   - 将Cookie粘贴到"B站Cookie"输入框中
   - 点击"保存设置"
